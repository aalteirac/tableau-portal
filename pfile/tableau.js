  ...
  ;(function(window, undefined) {
    ...
    window.tabportal.exportPDF=exportPDF;
    window.tabportal.exportData=exportData;
    window.tabportal.showCustomViews=showCustomViews;
    window.tabportal.poptrigAlert=poptrigAlert;
    window.tabportal.showDataAlertDialog=showDataAlertDialog;
    window.tabportal.showDataAlertMgmt=showDataAlertMgmt;
    window.tabportal.poptrigSubs=poptrigSubs;
    window.tabportal.showSubscriptionMgmt=showSubscriptionMgmt;
    window.tabportal.showSubscription=showSubscription;
    window.tabportal.launchEdit=launchEdit;
    window.tabportal.launchAsk=launchAsk;
    window.tabportal.deleteArtefacts=deleteArtefacts;
    window.tabportal.test=test;
})(window)
